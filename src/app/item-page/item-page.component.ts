...
export class ItemPageComponent implements OnInit {
  ...
  onChange(value:any,input:any){
    ...
    { console.log(value);
      ...
      this.oldItem[this.selectedItem].input=this.localItems[this.selectedItem].input;
      console.log(this.oldItem[this.selectedItem].input)
    }
    
  }


  sortAlphabetically(items:any){
  ...
  handleSubmit(form:NgForm){
    ...
    if((form.value.itemName != null || form.value.itemName != undefined || form.value.itemName!= '' ) && ( form.value.itemCode!=''|| form.value.itemCode != null ||form.value.itemCode != undefined ))
    { console.log(form.value.itemName)
      this.oldItem.push({
  ...
  handleUpdate(form:NgForm){
    ...
    if((form.value.itemName != null || form.value.itemName != undefined ) && ( form.value.itemCode != null ||form.value.itemCode != undefined ))  
    { console.log(this.localItems[this.selectedItem])
      ...
      this.localItems[this.selectedItem].purchaseprice = form.value.purchasePrice;
